...
class ServicesController extends Controller
{
            ...
            content: new OA\MediaType(
                ...
                schema: new OA\Schema(
                    ...
                    properties: [
                        ...
                        'env' => ['type' => 'string', 'description' => 'Environment variables for the service. It should be a string in .env file format.'],
                        'urls' => [
                            'type' => 'array',
    ...
    {
        $allowedFields = ['type', 'name', 'description', 'project_uuid', 'environment_name', 'environment_uuid', 'server_uuid', 'destination_uuid', 'instant_deploy', 'docker_compose_raw', 'env', 'urls', 'force_domain_override'];
        ...
        if ($serviceKeys->contains($request->type)) {
            ...
            $allowedFields = ['name', 'description', 'project_uuid', 'environment_name', 'environment_uuid', 'server_uuid', 'destination_uuid', 'instant_deploy', 'docker_compose_raw', 'env', 'connect_to_docker_network', 'urls', 'force_domain_override'];
            ...
            if ($request->has('env')) {
                $variables = parseEnvFormatToArray($request->env);
